...
title: "Warmup: Chicago House Beat"
subtitle:  Create a Chicago House beat with Python code
description: Create a Chicago House beat with Python code
level: Beginner
time: 15-20 minutes
license: by-nc-sa
splash: /images/house-beat.png
